    ...
    <section id="about" className="min-h-screen flex items-center py-20 bg-gray-900/50 px-6">
      <div className="container mx-auto max-w-6xl">
        <h2 className="font-heading text-2xl md:text-3xl font-semibold mb-16 text-center tracking-wide">
          <span className="text-gray-500">function</span> <span className="text-blue-400">getAboutMe</span><span className="text-gray-500">() {'{'}</span>
        </h2>
        ...
        <div className="text-center mt-8">
          <span className="text-gray-500 font-heading text-2xl">{'}'}</span>
        </div>
      </div>
    </section>
  )
